...
flowchart LR
  ...
  BS --> BOP["BattlefieldSituationObjectivePressure 据点防守压力：据点 / 归属 / 威胁来源 / 占点风险 / 推荐入口 / 态势对照 / 复盘线索"]
  ...
  CMR --> UI2
  FUR --> UI2
  BS --> UI3["侧栏战线态势：指令 / 待命 / 据点 / 威胁 / 反制 / 受威胁据点 / 据点压力 / 压力行当前态 / 压力态势对照 / 压力复盘线索 / 首要建议 / 执行反馈 / 敌方回合影响 / 响应历史 / 响应定位 / 复盘影响"]
  BOP --> UI3
  BOPC2 --> UI3
