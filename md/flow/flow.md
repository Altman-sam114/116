...
- 显示 MOVE、ATK、POS、NEXT、OBJ、CAP、THR、INT、AI 复盘、战线态势汇总、定位入口和下一步提示、补给线、控制区、攻击覆盖等标记。
...
9. `ContentView` 在侧栏靠前显示“战线态势”卡，展示 summary 的等级、指标、受威胁据点、建议说明、“定位”按钮和下一步入口提示；UI 不重新计算威胁、反制、据点、OBJ 计划、待命单位或入口类型。
